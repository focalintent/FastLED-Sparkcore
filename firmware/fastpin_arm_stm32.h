...
_DEFPIN_ARM(18, 3, A);
_DEFPIN_ARM(19, 2, A);
_DEFPIN_ARM(20, 7, C);  // Setup Button
_DEFPIN_ARM(21, 1, A);  // RGBR
_DEFPIN_ARM(22, 2, A);  // RGBG
_DEFPIN_ARM(23, 3, A);  // RGBB
_DEFPIN_ARM(24, 0, B);  // P1S0
_DEFPIN_ARM(25, 1, B);  // P1S1
_DEFPIN_ARM(26, 0, C);  // P1S2
_DEFPIN_ARM(27, 4, C);  // P1S3
_DEFPIN_ARM(28, 13, C); // P1S4
_DEFPIN_ARM(29, 1, C);  // P1S5
_DEFPIN_ARM(30, 8, A);  // P1S6
